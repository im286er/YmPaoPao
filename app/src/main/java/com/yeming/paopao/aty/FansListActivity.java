...
public class FansListActivity extends Activity {
    ...
    private int fansPageNum = 0 ;    //  粉丝列表当前页
    ...
    public void getUserFansList(){
        ...
        query.setSkip(Constant.PAGE_SIZE*(fansPageNum++));
        ...
        query.findObjects(context, new FindListener<User>() {
            ...
            public void onSuccess(List<User> users) {
                ...
                LogUtil.d(TAG,"---getUserFansList Success----"+users.size());
                if(users.size()!=0&&users.get(users.size()-1)!=null){
                    ...
                    LogUtil.d(TAG,"---getUserFansList Success----暂无更多数据");
            ...
            public void onError(int i, String s) {
                ...
                LogUtil.d(TAG,"-----getUserFansList Error--code="+i+"____"+s);
                if(fansPageNum > 0){
                    fansPageNum--;
                }
                if(mRefreshType==RefreshType.REFRESH){
                    LogUtil.d(TAG,"-----getUserFansList Error--RefreshType.REFRESH");
                    swipeRefreshLayout.setRefreshing(false);
                }else if(mRefreshType==RefreshType.LOAD_MORE){
                    LogUtil.d(TAG, "-----getUserFansList Error--RefreshType.LOAD_MORE");
                    swipeRefreshLayout.setLoading(false);
                }
            }
        }) ;
